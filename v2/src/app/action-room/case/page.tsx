...
export default function CasePage() {
  ...
  const { kase, elapsedMin, toggleAction, update } = useCase();
  ...
  useEffect(() => {
    if (kase) return;
    const redirectTimer = window.setTimeout(() => router.replace("/action-room/intake"), 250);
    return () => window.clearTimeout(redirectTimer);
  }, [kase, router]);

  if (!kase) {
    return <main className="app-page"><p style={{ color: "var(--ink-3)" }}>Opening your action room</p></main>;
  }
  ...
  return (
    <main className="app-page">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <Link href="/action-room/intake" className="btn btn-secondary px-3.5 py-2 text-[13.5px]">
            Start over
          </Link>
        </div>
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-12">
          ...
          <div className="space-y-5 lg:col-span-7">
            ...
            >
              ...
              <Link href="/action-room/frozen" className="btn btn-secondary px-4 py-2.5 text-[14px]">
